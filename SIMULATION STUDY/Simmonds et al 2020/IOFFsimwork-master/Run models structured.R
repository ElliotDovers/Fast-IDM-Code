...
return(list(join.stack = join.stack, result = result.struct.binom, mesh = data.frame(x = mesh$loc[,1], y = mesh$loc[,2], w = rep(NA, nrow(mesh$loc))))) # weights aren't used here so set to NA
