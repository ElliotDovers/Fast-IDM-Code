...
# Get the job array
# tab <- read.csv("job_array_test.csv")
...
source("mgcv_test.R")
res <- mgcv_test(structured_data = structured_data, unstructured_data = unstructured_data, quad = quad, pred = pred, domain.data = domain.data)
